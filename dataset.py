...
@st.cache_data
def get_data():
    df1 = pd.read_csv('C:/Users/Mahesh/Desktop/TE/Second Sem/Mini Project/Cricketers Performance Analysis using Visualization (StreamLit)/Project/Datasets/Ball_by_ball_data.csv')
    df2 = pd.read_csv('C:/Users/Mahesh/Desktop/TE/Second Sem/Mini Project/Cricketers Performance Analysis using Visualization (StreamLit)/Project/Datasets/Match_data.csv')
    df3 = pd.read_csv('C:/Users/Mahesh/Desktop/TE/Second Sem/Mini Project/Cricketers Performance Analysis using Visualization (StreamLit)/Project/Datasets/Summary.csv')
    df4 = pd.read_csv('C:/Users/Mahesh/Desktop/TE/Second Sem/Mini Project/Cricketers Performance Analysis using Visualization (StreamLit)/Project/Datasets/city_df.csv')
